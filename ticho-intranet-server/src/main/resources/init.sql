...
INSERT INTO sys_dict (id, code, name, is_sys, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1746819045291720704, 'commonStatus', '通用状态', 0, 1, NULL, 0, 'admin', '2024-01-15 16:58:09', 'admin', '2024-01-19 14:23:49', 0);
INSERT INTO sys_dict (id, code, name, is_sys, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1747613546708992000, 'yesOrNo', '是否', 0, 1, NULL, 0, 'admin', '2024-01-17 21:35:13', 'admin', '2024-01-19 14:58:59', 0);
INSERT INTO sys_dict (id, code, name, is_sys, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748240900481351680, 'userStatus', '用户状态', 0, 1, NULL, 0, 'admin', '2024-01-19 15:08:06', 'admin', '2024-01-19 15:46:39', 0);
INSERT INTO sys_dict (id, code, name, is_sys, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748248903905443840, 'menuType', '菜单类型', 0, 1, NULL, 0, 'admin', '2024-01-19 15:39:54', 'admin', '2024-01-19 15:46:34', 0);
INSERT INTO sys_dict (id, code, name, is_sys, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748261738358243328, 'protocolType', '协议类型', 0, 1, NULL, 0, 'admin', '2024-01-19 16:30:54', NULL, NULL, 0);
...
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1746819115722473472, 'commonStatus', '启用', '1', 10, 1, NULL, 0, 'admin', '2024-01-15 16:58:26', 'admin', '2024-01-19 14:28:37', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1746819180134400000, 'commonStatus', '停用', '0', 15, 1, NULL, 0, 'admin', '2024-01-15 16:58:42', 'admin', '2024-01-17 21:34:24', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1747613674828201984, 'yesOrNo', '是', '1', 10, 1, NULL, 0, 'admin', '2024-01-17 21:35:44', 'admin', '2024-01-18 22:38:59', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1747613713164140544, 'yesOrNo', '否', '0', 20, 1, NULL, 0, 'admin', '2024-01-17 21:35:53', 'admin', '2024-01-18 22:39:02', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748242704657022976, 'userStatus', '正常', '1', 10, 1, NULL, 0, 'admin', '2024-01-19 15:15:16', 'admin', '2024-01-19 15:18:43', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748242754888007680, 'userStatus', '未激活', '2', 20, 1, NULL, 0, 'admin', '2024-01-19 15:15:28', 'admin', '2024-01-19 15:18:51', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748243717862457344, 'userStatus', '已锁定', '3', 30, 1, NULL, 0, 'admin', '2024-01-19 15:19:18', 'admin', '2024-01-19 15:20:15', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748244029088202752, 'userStatus', '已注销', '4', 40, 1, NULL, 0, 'admin', '2024-01-19 15:20:32', NULL, NULL, 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748249124630691840, 'menuType', '目录', '1', 10, 1, NULL, 0, 'admin', '2024-01-19 15:40:47', 'admin', '2024-01-19 15:50:03', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748249178116456448, 'menuType', '菜单', '2', 20, 1, NULL, 0, 'admin', '2024-01-19 15:41:00', 'admin', '2024-01-19 15:41:22', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748249227869290496, 'menuType', '按钮', '3', 30, 1, NULL, 0, 'admin', '2024-01-19 15:41:11', NULL, NULL, 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748261877877571584, 'protocolType', 'HTTP', '1', 10, 1, NULL, 0, 'admin', '2024-01-19 16:31:27', 'admin', '2024-01-19 16:31:53', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748261927231946752, 'protocolType', 'HTTPS', '2', 20, 1, NULL, 0, 'admin', '2024-01-19 16:31:39', 'admin', '2024-01-19 16:33:30', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748262053644075008, 'protocolType', 'SSH', '3', 30, 1, NULL, 0, 'admin', '2024-01-19 16:32:09', 'admin', '2024-01-19 16:33:36', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748262127493185536, 'protocolType', 'TELNET', '4', 40, 1, NULL, 0, 'admin', '2024-01-19 16:32:27', 'admin', '2024-01-19 16:33:55', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748262168333123584, 'protocolType', 'DATABASE', '5', 50, 1, NULL, 0, 'admin', '2024-01-19 16:32:37', 'admin', '2024-01-19 16:34:09', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748262274067333120, 'protocolType', 'RDESKTOP', '6', 60, 1, NULL, 0, 'admin', '2024-01-19 16:33:02', 'admin', '2024-01-19 16:34:17', 0);
INSERT INTO sys_dict_label (id, code, label, value, sort, status, remark, version, create_by, create_time, update_by, update_time, is_delete) VALUES(1748262311816069120, 'protocolType', 'TCP', '7', 70, 1, NULL, 0, 'admin', '2024-01-19 16:33:11', 'admin', '2024-01-19 16:34:26', 0);
...
INSERT INTO `sys_port` VALUES (1686385202043027456,'68bfe8f0af124ecfa093350ab8d4b44f',80,'127.0.0.1:5122',NULL,1,1,NULL,1,80,NULL,0,'admin','2023-08-01 22:35:38','admin','2024-01-14 17:39:51',0);
...
INSERT INTO `sys_role` VALUES (1620586462021824513,'admin','管理员',1,'',0,'zhajianjun','2023-02-01 08:54:56','admin','2024-01-12 21:03:19',0);
...
INSERT INTO `sys_user` VALUES (1580743544448905218,'admin','$2a$10$E/mhGMUGKHcn8G1VYTDdXut4YgxmbtZ2qj7WmUrEN3/rlhwe9aVzG','管理员','管理员',NULL,NULL,NULL,NULL,NULL,NULL,'1@qq.com',1,NULL,'1',NULL,NULL,NULL,1,'123123',0,NULL,'2022-10-14 10:13:24','admin','2024-01-19 15:53:50',0);
...
INSERT INTO `sys_user_role` VALUES (1697448140262621186,1620586462021824513),(1580743544448905218,1620586462021824513);
